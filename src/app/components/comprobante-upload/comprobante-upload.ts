...
@Component({
  selector: 'app-comprobante-upload',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './comprobante-upload.html',
  styleUrl: './comprobante-upload.css'
})
export class ComprobanteUploadComponent {
  ...
  async uploadComprobante() {
    if (!this.selectedFile) {
      this.error = 'Selecciona un comprobante';
      return;
    }
